...
void ATM::handleDeposit() {
    ...
    while (true) {
        ...
        auto depositTransaction = TransactionFactory::createDepositTransaction(primaryBank,cashManager, amount, currentAccount, depositType, currentCardNumber);
...
void ATM::handleWithdrawal() {
    ...
    // Create transaction
    auto withdrawalTransaction = TransactionFactory::createWithdrawalTransaction(primaryBank,cashManager, amount, currentAccount, currentCardNumber);
...
void ATM::handleTransfer() {
    ...
    // Create transaction
    auto transferTransaction = TransactionFactory::createTransferTransaction(primaryBank,cashManager,amount, currentAccount, destinationAccount, transferType, currentCardNumber);
